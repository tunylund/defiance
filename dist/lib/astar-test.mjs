import { buildGrid } from './../node_modules/tiny-game-engine/src/grid.mjs';
import { unit } from './../node_modules/tiny-game-engine/src/xyz.mjs';
import { findPath, findPathCached } from './astar.mjs';
const SIZE = 1000;
const c = console;
const out = c.log;
